...
export class TestCreateDb extends Command<void> {
    constructor(
...
@CommandHandler(TestCreateDb)
export class TestCreateDbHandler implements ICommandHandler<TestCreateDb> {
    constructor(
    ...
    async execute(
        ...
        return await this.sessionsCommandRepository.toTestCreateDb();
    }
}